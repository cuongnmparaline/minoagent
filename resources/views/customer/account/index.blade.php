            ...
            <div class="table-responsive">
                <table class="table text-start align-middle table-bordered table-hover mb-0">
                    ...
                    <tr>
                        ...
                        <td>@if(!empty($account['date'])) {{ $account['date'] }} @else {{ $account->reports->first()->date }} @endif</td>
                        <td>@if(!empty($account['amount'])) {{ $account['amount'] }} @else {{ $account->reports->first()->amount }} @endif</td>
                        <td>@if(!empty($account['amount_fee'])) {{ $account['amount_fee'] }} @else {{ $account->reports->first()->amount_fee }} @endif</td>
                        <td>
