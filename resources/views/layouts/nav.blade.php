    ...
    <div class="navbar-nav align-items-center ms-auto">
        ...
        <div class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                ...
                <span class="d-none d-lg-inline-flex">@if(\Illuminate\Support\Facades\Auth::guard('customer')->check())
            ...
            <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                ...
                @endif" class="dropdown-item">My Profile</a>
                <a href="@if(\Illuminate\Support\Facades\Auth::guard('customer')->check())
                {{ route('customer.logout') }}
                @else
                {{ route('logout') }}
                @endif" class="dropdown-item">Log Out</a>
            </div>
        </div>
    </div>
</nav>
