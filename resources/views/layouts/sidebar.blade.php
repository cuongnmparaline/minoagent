...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            ...
            <a href="{{ route('management.history') }}" class="nav-item nav-link {{ request()->is('management/history*') ? 'active' : '' }}"><i class="fa fa-chart-bar me-2"></i>History Top Up</a>
            ...
            @if(\Illuminate\Support\Facades\Auth::guard('customer')->check())
                ...
                <a href="{{ route('customer.account') }}" class="nav-item nav-link {{ request()->is('customer/account*') ? 'active' : '' }}"><i class="fa fa-chart-bar me-2"></i>Account</a>
                    <a href="{{ route('customer.history') }}" class="nav-item nav-link {{ request()->is('customer/history*') ? 'active' : '' }}"><i class="fa fa-chart-bar me-2"></i>History Top Up</a>
